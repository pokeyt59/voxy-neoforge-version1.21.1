...
public class ClientImportManager extends ImportManager {
    protected class ClientImportTask extends ImportTask {
        ...
        protected ClientImportTask(IDataImporter importer) {
            ...
            this.bossBar = new LerpingBossEvent(this.bossbarUUID, Component.literal("Voxy world importer"), 0.0f, BossEvent.BossBarColor.GREEN, BossEvent.BossBarOverlay.PROGRESS, false, false, false);
        ...
        protected boolean onUpdate(int completed, int outOf) {
            ...
            Minecraft.getInstance().execute(()->{
                ...
                this.bossBar.setName(Component.literal("Voxy import: " + completed + "/" + outOf + " chunks"));
            });
            return true;
        }
